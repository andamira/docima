...
//! # How to use
//!
//! 1. Create your build script in the default location (`./build.rs`)
//!    or configure a different path in your `Cargo.toml`.
//! 2. Add as well the necessary dependencies to build your images. E.g.:
//!
//! ```toml
...
//! # Example
//!
//! See also the full [provided example](https://github.com/joseluis/docima/tree/master/example).
...
///
/// # Parameters
/// - `f`: a function that takes a mutable buffer, a width, a height,
